<div class="section-row sticky-container">
    <div class="main-post">
        ...
        <figure class="figure-img">
            <img class="img-responsive" src="<?= ASSETS_PATH ?>img/post-4.jpg" alt="">
...
<div class="section-row text-center">
    <a href="#" style="display: inline-block;margin: auto;"> <img class="img-responsive" src="<?= ASSETS_PATH ?>img/ad-2.jpg" alt=""> </a>
</div>

<div class="section-row">
    <div class="post-author">
        <div class="media">
            <div class="media-left"> <img class="media-object" src="<?= ASSETS_PATH ?>img/author.png" alt=""></div>
